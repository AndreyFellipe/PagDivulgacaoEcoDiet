    ...
    <div>
            ...
            <div className="flex items-center">
              ...
              <div className="hidden lg:block">
                <div className="flex space-x-2">
                  <Link href="/equipe">
                    <p className="text-green-600  hover:text-white pl-2 text-lg font-medium">
                      Equipe
                    </p>
                  </Link>
        ...
        {isOpen && (
          <div className="lg:hidden" id="mobile-menu">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <Link href="/equipe">
                <p className="text-green-600  hover:text-white block pl-2 text-base font-medium">
                  Equipe
                </p>
              </Link>
              <Link href="https://app-ecodiet.vercel.app/">
      ...
      >
        <div className="flex flex-col items-center justify-center">
          {/* Grupo 1 */}
          <h2 className="mb-8 text-2xl font-bold text-center md:text-4xl lg:text-5xl text-[#2c7b35]">
          ...
          <div className="flex flex-wrap justify-center mb-16">
            <Fragment>
              ...
              >
                ...
                />
                <p
                  className="text-2xl md:text-3xl lg:text-3xl w-48"
                  style={{ textAlign: "center" }}
                >
                  Amintas Gomes de Moraes Neto
                </p>
                <div className="my-2" style={{ display: "flex", alignItems: "center" }}>
                <Link href="https://github.com/AmintasNeto">
                  <Image src={github} alt="github" className="mr-2" />
                  </Link>
                <Link href="https://www.linkedin.com/in/amintas-gomes-de-moraes-neto-533947235/">
                  <Image src={linkedin} alt="linkedin" className="mr-2" />
                  </Link>
                </div>
              </div>
            </Fragment>
            <Fragment>
              ...
              >
                ...
                <div className="my-2" style={{ display: "flex", alignItems: "center" }}>
                <Link href="https://github.com/AndreyFellipe">
                  <Image src={github} alt="github" className="mr-2" />
                  </Link>
                <Link href="https://www.linkedin.com/in/dreyf/">
                  <Image src={linkedin} alt="linkedin" className="mr-2" />
                  </Link>
                </div>
              </div>
            ...
            <Fragment>
              ...
              >
                ...
                <div className="my-2" style={{ display: "flex", alignItems: "center" }}>
                <Link href="https://github.com/CristianDG">
                  <Image src={github} alt="github" className="mr-2" />
                  </Link>
                <Link href="https://www.linkedin.com/in/cristian-dg/">
                  <Image src={linkedin} alt="linkedin" className="mr-2" />
                  </Link>
                </div>
              </div>
            ...
            <Fragment>
              ...
              >
                ...
                <div className="my-2" style={{ display: "flex", alignItems: "center" }}>
                <Link href="https://github.com/lofi1245">
                  <Image src={github} alt="github" className="mr-2" />
                  </Link>
                <Link href="https://www.linkedin.com/in/diego-gomes-688464200/">
                  <Image src={linkedin} alt="linkedin" className="mr-2" />
                  </Link>
                </div>
                </div>
            ...
            <Fragment>
              ...
              >
                ...
                <div className="my-2" style={{ display: "flex", alignItems: "center" }}>
                <Link href="https://github.com/Jorgelucasmota">
                  <Image src={github} alt="github" className="mr-2" />
                  </Link>
                <Link href="https://www.linkedin.com/in/jorge-lucas-4674341bb/">
                  <Image src={linkedin} alt="linkedin" className="mr-2" />
                  </Link>
                </div>
              </div>
            ...
            <Fragment>
              ...
              >
                ...
                <p
                  ...
                  style={{ textAlign: "center" }}
                >
                  Natan da Silva Batista
                </p>
                <div className="my-2" style={{ display: "flex", alignItems: "center" }}>
                <Link href="https://github.com/NatanBatista">
                  <Image src={github} alt="github" className="mr-2" />
                  </Link>
                <Link href="https://www.linkedin.com/in/natan-batista-5589aa1bb/">
                  <Image src={linkedin} alt="linkedin" className="mr-2" />
                  </Link>
                </div>
              </div>
            ...
            <Fragment>
              ...
              >
                ...
                <div className="my-2" style={{ display: "flex", alignItems: "center" }}>
                <Link href="https://github.com/pedritto19">
                  <Image src={github} alt="github" className="mr-2" />
                  </Link>
                <Link href="https://www.linkedin.com/in/pedro-henrique-9169851bb/">
                  <Image src={linkedin} alt="linkedin" className="mr-2" />
                  </Link>
                </div>
              </div>
      ...
      >
        <span className="text-xl md:text-2xl lg:text-3xl">
          Contato: ecodiet@dcomp.ufs.br
        </span>
        <Image src={dcomp} alt="dcomp" className="w-[440px] " />
      </footer>
    </div>
  );
}
